...
(function () {
  ...
  const ICONS = {
    ...
    football: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><circle cx="12" cy="12" r="10"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10"/><path d="M12 2a15.3 15.3 0 0 0-4 10 15.3 15.3 0 0 0 4 10"/><line x1="12" y1="2" x2="12" y2="22"/><polyline points="4.9 4.9 12 12 19.1 4.9"/></svg>',
  };
  ...
  const TABS = [
    ...
    { id: 'football', label: 'Football', panelId: 'tab-panel-football', iframeSrc: 'football.html?embed=1' },
  ];
